...
$("#Res-prodnav").on("click",function (e) {
    ...
    $(document).delegate(".product-naviation div", "click", function (e) {
        viewdemo(e.target.textContent);
		$(".productlogo").removeClass().addClass("productlogo");
		$(".productlogo").addClass(e.target.textContent.toLowerCase()+"logo");
    });
...
//After the sample page load footer will be loaded.
	...
	//resizing for content fluid width 
		...
		$(".scrollit .row").attr("style","min-height:"+(($(window).height() - $(".sbheader").outerHeight()- $("#footer").outerHeight() - 23))+"px;");	
	}
	...
	$(".control-panel,.sbheader,.cols-sample-area").click(function(e) { 
	samplelisthide();
      });
    ...
    $(window).bind("resize", function () {
        var viewportWidth = $(window).width();
        if (viewportWidth < 981 && !ej.isMobile()) {
            $('.content-container-fluid .row > .navigation').addClass('collapsePanel');
            $('.accordion-panel').removeClass("expandPanel");
        }
		refreshScroller();
...
window.menuData = [{ id: 1, text: "", parentId: null,spriteCssClass:"e-icon" },
                    { id: 2, text: "Flat-Azure", parentId: 1, imageUrl: "themes/images/themeicon/flat_azure.png" },
                    { id: 3, text: "Flat-Azure-Dark", parentId: 1, imageUrl: "themes/images/themeicon/flat_azure_dark.png" },
                    { id: 4, text: "Flat-Lime", parentId: 1, imageUrl: "themes/images/themeicon/flat_lime.png" },
                    { id: 5, text: "Flat-Lime-Dark", parentId: 1, imageUrl: "themes/images/themeicon/flat_lime_dark.png" },
                    { id: 6, text: "Flat-Saffron", parentId: 1, imageUrl: "themes/images/themeicon/flat_saffron.png" },
                    { id: 7, text: "Flat-Saffron-Dark", parentId: 1, imageUrl: "themes/images/themeicon/flat_saffron_dark.png" },
                    { id: 8, text: "Gradient-Azure", parentId: 1, imageUrl: "themes/images/themeicon/gradient_azure.png" },
                    { id: 9, text: "Gradient-Azure-Dark", parentId: 1, imageUrl: "themes/images/themeicon/gradient_azure_dark.png" },
                    { id: 10, text: "Gradient-Lime", parentId: 1, imageUrl: "themes/images/themeicon/gradient_lime.png" },
                    { id: 11, text: "Gradient-Lime-Dark", parentId: 1, imageUrl: "themes/images/themeicon/gradient_lime_dark.png" },
                    { id: 12, text: "Gradient-Saffron", parentId: 1, imageUrl: "themes/images/themeicon/gradient_saffron.png" },
                    { id: 13, text: "Gradient-Saffron-Dark", parentId: 1, imageUrl: "themes/images/themeicon/gradient_saffron_dark.png" },
                    { id: 14, text: "Bootstrap", parentId: 1, imageUrl: "themes/images/themeicon/bootstrap.png" }
];